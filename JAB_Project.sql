...
(1,'Mia Johnson','https://bootdey.com/img/Content/avatar/avatar3.png',"Més enllà de la taula de classe: La transformació de l'aprenentatge a través de la tecnologia",'','',"En els últims anys, la tecnologia ha tingut un impacte revolucionari en molts àmbits de la nostra vida, incloent-hi l'educació. Les aules ja no són el lloc exclusiu on es produeix l'aprenentatge, sinó que la tecnologia ha obert noves oportunitats per aprendre des de qualsevol lloc i en qualsevol moment.
...
(3,'Olivia Parker','https://bootdey.com/img/Content/avatar/avatar8.png',"Reimaginar la formació professional: Creant noves oportunitats per al creixement laboral",'','',"La formació professional és una part vital del desenvolupament de la carrera laboral. La tecnologia està canviant el mercat laboral a un ritme increïble, i els treballadors han de mantenir-se al dia amb les últimes tendències per mantenir la seva competitivitat en el mercat.
...
(12,'Ethan Campbell','https://bootdey.com/img/Content/avatar/avatar2.png',"La formació integral: Connectant amb les necessitats de tot l'ésser humà",'','',"La formació integral és un enfocament educatiu que busca connectar amb les necessitats de tot l'ésser humà, no només amb el seu desenvolupament acadèmic, sinó també amb el seu creixement personal i emocional.
...
(14,'Emma Brown','https://bootdey.com/img/Content/avatar/avatar6.png',"La formació al teu ritme: L'aprenentatge autònom en l'era digital",'','',"En l'era digital, la formació ha passat a estar a l'abast de tothom a través de la tecnologia i Internet. Això ha donat lloc a una nova forma d'aprendre que permet a l'estudiant establir el seu propi ritme d'aprenentatge, i és coneguda com a aprenentatge autònom.
...
(16,'Mia Johnson','https://bootdey.com/img/Content/avatar/avatar3.png',"La transformació educativa: Com la tecnologia canvia la manera d'ensenyar i aprendre",'','',"La tecnologia ha transformar molts aspectes de la nostra vida, i l'educació no és una excepció. Amb l'aparició de les noves tecnologies, s'ha obert un món de possibilitats per a l'ensenyament i l'aprenentatge, que estan canviant la manera com les persones accedeixen al coneixement.
...
(22,'Ethan Campbell','https://bootdey.com/img/Content/avatar/avatar2.png',"Aprendre dels experts: La formació en línia per als professionals de la indústria",'','',"En el món d'avui, la formació continua és un element clau per a qualsevol professional de la indústria. Però què passa quan els professionals no poden assistir a cursos presencials per raons logístiques o de temps? La resposta és la formació en línia, que permet als professionals aprendre dels experts en qualsevol lloc i en qualsevol moment.
...
(41,'Mia Johnson','https://bootdey.com/img/Content/avatar/avatar3.png',"Intel·ligència emocional: La importància de l'aprenentatge socioemocional",'','',"L'intel·ligència emocional és la capacitat de reconèixer i gestionar les pròpies emocions, així com les emocions dels altres. Aprendre a desenvolupar aquesta habilitat és important per al benestar personal i la capacitat de relacionar-se amb els altres de manera efectiva. Per això, l'educació socioemocional està guanyant terreny en el panorama educatiu actual.
...
(45,'Benjamin White','https://bootdey.com/img/Content/avatar/avatar7.png',"Aprenentatge en equip: Com treballar en grup pot millorar la formació",'','',"L'aprenentatge en equip és una metodologia que busca fomentar la cooperació i el treball en grup per millorar la formació. Aquesta metodologia va més enllà de la simple divisió de tasques i la col·laboració superficial, ja que involucra a totes les persones en la presa de decisions i en la resolució de problemes. L'objectiu és crear un ambient d'aprenentatge en què cada membre del grup se senti part del procés i pugui aportar la seva perspectiva i les seves habilitats per aconseguir un objectiu comú.
...
(47,'Ethan Campbell','https://bootdey.com/img/Content/avatar/avatar2.png',"Aprenentatge reflexiu: Com la reflexió pot millorar la comprensió i el creixement personal",'','',"L'aprenentatge reflexiu és una eina valuosa que pot ajudar els estudiants a millorar la seva comprensió, aplicar el que han après i desenvolupar les seves pròpies idees i perspectives. Aquesta metodologia es centra en la reflexió, la introspecció i l'autoavaluació, i té com a objectiu principal que els estudiants siguin conscients de la seva pròpia manera de pensar i d'aprendre, i que puguin millorar-la mitjançant la reflexió crítica.
